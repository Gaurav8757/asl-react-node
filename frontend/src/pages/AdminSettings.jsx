...
export default function AdminSettings() {
  ...
  useEffect(() => {
    const endpoint = 'AdminSettings' === 'AdminAnalytics' ? '/analytics'
      : 'AdminSettings' === 'AdminLogs' ? '/logs'
      : 'AdminSettings' === 'MemberTasks' ? '/tasks/my'
      : null;
    if (endpoint) {
  ...
  return (
    <div>
      <div className="page-title" style={{ marginBottom:'24px' }}>AdminSettings</div>
