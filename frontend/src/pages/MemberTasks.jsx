...
export default function MemberTasks() {
  ...
  useEffect(() => {
    const endpoint = 'MemberTasks' === 'AdminAnalytics' ? '/analytics'
      : 'MemberTasks' === 'AdminLogs' ? '/logs'
      : 'MemberTasks' === 'MemberTasks' ? '/tasks/my'
      : null;
    if (endpoint) {
  ...
  return (
    <div>
      <div className="page-title" style={{ marginBottom:'24px' }}>MemberTasks</div>
